...
For this project you will need tensorflow, opencv for python, and pillow, also since tensorflow does not yet support python 3.12 you will need python 3.11 or lower. I personally ran it in a virtual environment in Fedora but any OS should be able to run it.
